import {
  ...
  export const RiskMetricSelector = (MetricProps: MetricPropsType) => {
    ...
    const onMetricSelected = (value: any) => {
      ...
      setPopupError(false);
      MetricProps.metricData[MetricProps.currentIndex].selectedMetric = value
      MetricProps.setMetricData([...MetricProps.metricData]);
    };
